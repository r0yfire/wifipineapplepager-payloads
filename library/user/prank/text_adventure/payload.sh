...
# Navigate the neon-lit streets using UP/DOWN to make your choices.
#
...
The game must have:
- Exactly 4 decision steps with 2 choices each (UP button and DOWN button)
...
get_choice() {
    ...
    if [ -z "$next_node" ]; then
        ...
        LOG red "Node '$CURRENT_NODE' missing choice_up/choice_down"
        return 1
    fi
...
LOG blue "▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄"
LOG ""
LOG "[UP/DOWN] Navigate choices"
LOG ""
LOG "Press any key to jack in..."
...
# Step 6: End screen
LOG ""
LOG "Press any key to disconnect..."
_input=$(WAIT_FOR_INPUT)
